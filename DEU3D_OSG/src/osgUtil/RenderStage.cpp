...
{
    DrawInnerOperation(const std::string &name, RenderStage* stage, osg::RenderInfo& renderInfo) : 
...
void RenderStage::draw(osg::RenderInfo& renderInfo,RenderLeaf*& previous)
{
    ...
    {
#if 1
        ref_ptr<osg::BlockAndFlushOperation> block = new osg::BlockAndFlushOperation("BlockAndFlushOperation in RenderState");
    
        useThread->add(new DrawInnerOperation("DrawInnerOperation in GraphicsThread of GraphicsContext", this, renderInfo ));
