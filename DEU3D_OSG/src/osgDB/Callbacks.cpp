...
ReaderWriter::ReadResult ReadFileCallback::readObject(const std::string& filename, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readObjectImplementation(filename,options);
}
ReaderWriter::ReadResult ReadFileCallback::readObject(const ID& id, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readObjectImplementation(id,options);
}

ReaderWriter::ReadResult ReadFileCallback::readImage(const std::string& filename, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readImageImplementation(filename,options);
}
ReaderWriter::ReadResult ReadFileCallback::readImage(const ID& id, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readImageImplementation(id,options);
}

ReaderWriter::ReadResult ReadFileCallback::readHeightField(const std::string& filename, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readHeightFieldImplementation(filename,options);
}
ReaderWriter::ReadResult ReadFileCallback::readHeightField(const ID& id, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readHeightFieldImplementation(id,options);
}

ReaderWriter::ReadResult ReadFileCallback::readNode(const std::string& filename, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readNodeImplementation(filename,options);
}
ReaderWriter::ReadResult ReadFileCallback::readNode(const ID& id, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readNodeImplementation(id,options);
}

ReaderWriter::ReadResult ReadFileCallback::readShader(const std::string& filename, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readShaderImplementation(filename,options);
}
ReaderWriter::ReadResult ReadFileCallback::readShader(const ID& id, const Options* options, const Referenced *creationInfo)
{
    return osgDB::Registry::instance()->readShaderImplementation(id,options);
}
