...
void Texture2DArray::apply(State& state) const
{
    ...
    TextureObject &textureObject = const_cast<Texture2DArray &>(*this).getTextureObject(contextID);

    if (textureObject.isValid() && _textureDepth>0)
    {
    ...
    else if (imagesValid())
    {
        ...
        textureObject.generate(GL_TEXTURE_2D_ARRAY_EXT);
