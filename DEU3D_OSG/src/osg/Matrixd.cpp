...
#ifdef X64
    cmm::MemPool osg::RefMatrixd::ms_MemPool(240u, 256u * 1024u, false, "PoolFor[RefMatrixd]");
#else
    cmm::MemPool osg::RefMatrixd::ms_MemPool(192u, 256u * 1024u, false, "PoolFor[RefMatrixd]");
#endif
