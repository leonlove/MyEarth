...
StateSetManipulator::StateSetManipulator(osg::StateSet* stateset):
    ...
    _keyEventToggleBackfaceCulling(osgGA::GUIEventAdapter::KEY_F2),
    _keyEventToggleLighting(osgGA::GUIEventAdapter::KEY_F3),
    _keyEventToggleTexturing(osgGA::GUIEventAdapter::KEY_F4),
    _keyEventCyclePolygonMode(osgGA::GUIEventAdapter::KEY_F5)
{
