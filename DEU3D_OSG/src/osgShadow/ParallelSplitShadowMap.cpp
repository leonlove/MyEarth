...
void ParallelSplitShadowMap::init()
{
    ...
    for (unsigned int iCameras=0;iCameras<iCamerasMax;iCameras++)
    {
        ...
        // set up the render to texture camera.
        {
            ...
            pssmShadowSplitTexture._camera->addCullCallback(new CameraCullCallback(this));
        ...
        if ( _displayTexturesGroupingNode ) {
            {
                ...
                pssmShadowSplitTexture._debug_camera->addCullCallback(new CameraCullCallback(this));
